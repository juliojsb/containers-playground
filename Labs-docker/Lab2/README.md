...
## Creando la imagen de forma interactiva (modificando el contenedor)
...
## Creando la imagen usando un Dockerfile
...
## Creando la imagen importando un fichero comprimido
